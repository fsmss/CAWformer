...
from layers.CAWformer import CAWformer
#from layers.leddamyuan import Leddam
...
class Model(nn.Module):
    def __init__(self, configs):
        ...
        self.leddam=CAWformer(configs.enc_in,configs.seq_len,configs.d_model,
                       configs.dropout,configs.pe_type,kernel_size=25,n_layers=configs.n_layers,klist=configs.klist,rate=configs.rate)
