...
if __name__ == '__main__':
    ...
    parser.add_argument('--d_model', type=int, default=128, help='model input size')
    ...
    parser.add_argument('--revin', type=bool, default=True, help='using revin from non-stationary transfor  mer')
    parser.add_argument('--klist', type=list, default=[35,25,15], help='encoder input size')
    #sad
    parser.add_argument('--rate', type=int, default=0.001, help='encoder input size')
    # optimization
